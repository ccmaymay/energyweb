 ...
 */
 ...
 /*
  * Jan 13, 2011
  * Fixed PM hour malformatting when showPeriod=true and showLeadingZero=true -- Chandler May
  */
...
(function ($, undefined) {
    ...
    $.extend(Timepicker.prototype, {
        ...
        _generateHTML: function (inst) {
            ...
            for (h = 12; h <= 17; h++) {
                html += this._generateHTMLHourCell(inst, h, (h > 12) && showPeriod ? (showLeadingZero ? "0" + (h - 12).toString() : (h - 12).toString()) : h.toString());
            }

            html += '</tr><tr>';
            for (h = 18; h <= 23; h++) {
                html += this._generateHTMLHourCell(inst, h, showPeriod ? ((h - 12 < 10) && showLeadingZero ? "0" + (h - 12).toString() : (h - 12).toString()) : h.toString());
            }
